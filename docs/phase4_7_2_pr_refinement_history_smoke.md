...
- PR limit for this run: `5`.

## Main result

- PRs analyzed: `0`
- Commit snapshots analyzed: `0`
- Review-response transitions: `0`
- Median heuristic Conway risk proxy, first -> final: `0.000` -> `0.000`
...
|---|---:|---:|---:|---:|
| `conway_risk_proxy` | 0.000 | 0.0% | 0.000 | 0.0% |
...
| `ownership_diffusion` | 0.000 | 0.0% | 0.000 | 0.0% |
| `boundary_density` | 0.000 | 0.0% | 0.000 | 0.0% |
...
- Snapshot rows: `data/phase4_7_2_pr_refinement_history_smoke.jsonl`
- Summary JSON: `data/phase4_7_2_pr_refinement_history_smoke_summary.json`
