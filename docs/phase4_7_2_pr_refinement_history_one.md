...
- PR limit for this run: `1`.

## Main result

- PRs analyzed: `1`
- Commit snapshots analyzed: `36`
- Review-response transitions: `0`
- Median heuristic Conway risk proxy, first -> final: `3.725` -> `4.119`
...
|---|---:|---:|---:|---:|
| `conway_risk_proxy` | 0.394 | 0.0% | 0.000 | 0.0% |
| `conway_risk_flags` | -1.000 | 100.0% | 0.000 | 0.0% |
| `api_change_without_tests` | 0.000 | 0.0% | 0.000 | 0.0% |
| `public_api_without_docs` | -1.000 | 100.0% | 0.000 | 0.0% |
| `shared_change_isolated` | 0.000 | 0.0% | 0.000 | 0.0% |
| `ownership_diffusion` | 0.119 | 0.0% | 0.000 | 0.0% |
| `boundary_density` | -0.367 | 100.0% | 0.000 | 0.0% |
...
- Snapshot rows: `data/phase4_7_2_pr_refinement_history_one.jsonl`
- Summary JSON: `data/phase4_7_2_pr_refinement_history_one_summary.json`
